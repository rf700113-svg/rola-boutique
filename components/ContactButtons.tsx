    ...
    <div className={compact ? "flex flex-wrap gap-3" : "grid gap-3 sm:flex"}>
      {showLine ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center justify-center gap-2 bg-[#06C755] px-6 py-3 text-sm tracking-[0.16em] text-white transition hover:bg-[#05B54D]"
        >
      ...
      {showFacebook ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center justify-center gap-2 border border-[#1877F2] bg-[#1877F2] px-6 py-3 text-sm tracking-[0.16em] text-white transition hover:bg-[#166FE5]"
        >
          <Facebook size={18} />
          Facebook 最新穿搭
        </a>
