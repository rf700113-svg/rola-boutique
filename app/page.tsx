...
export default async function Home() {
  ...
  return (
    <>
      <section
        className="relative flex h-[65vh] min-h-[500px] items-center overflow-hidden bg-charcoal bg-cover bg-[60%_center] sm:h-[58vh] sm:min-h-[560px] sm:bg-center"
        style={{
          backgroundImage:
      ...
      >
        <div className="w-full -translate-y-[5%] px-5 pb-8 pt-24 sm:px-[9vw]">
      ...
      <section className="bg-ivory px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-7 md:grid-cols-[1fr_auto] md:items-center md:gap-8">
          <div>
            ...
            <h2 className="mt-3 whitespace-nowrap font-serif text-[clamp(30px,8vw,42px)] leading-[1.25] tracking-normal text-charcoal">
              加入 ROLA LINE
            </h2>
            <p className="mt-3 text-sm leading-7 text-charcoal/70 sm:text-base">新品詢問｜尺寸建議｜一對一穿搭服務</p>
          </div>
          <a
            href={lineUrl}
            target="_blank"
