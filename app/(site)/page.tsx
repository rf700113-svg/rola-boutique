...
import { getBrandSettings, getHomeSettings, getSocialSettings } from "@/lib/settings";

export const dynamic = "force-dynamic";

export default async function Home() {
  const [newArrivals, home, social, brand] = await Promise.all([
    getProductsByFeature("new"),
    getHomeSettings(),
    getSocialSettings(),
    getBrandSettings()
  ]);
  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(90deg, rgba(20,20,20,0.45) 0%, rgba(20,20,20,0.22) 35%, rgba(20,20,20,0.05) 70%, rgba(20,20,20,0) 100%), url('${home.heroImage}')`
        }}
      >
        <div className="w-full -translate-y-[5%] px-5 pb-6 pt-20 sm:px-[9vw] sm:pt-24">
          <div className="w-[86%] max-w-[390px] text-[#F6F2ED] sm:w-full sm:max-w-[520px]">
            ...
            <div className="mt-6 grid gap-2.5 sm:mt-7 sm:flex sm:flex-wrap sm:gap-3">
              <Link
                href={home.primaryButtonLink || "/products"}
      ...
      <section id="new-arrivals" className="bg-cream px-4 py-12 sm:px-6 sm:py-18 lg:px-8">
